...
use MyPlugin\Framework\Database\Orm\ModelNotFoundException;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  array  $columns
     * @return \MyPlugin\Framework\Database\Orm\Model|static
     *
     ...
     *
     * @param  \MyPlugin\Framework\Database\Orm\Model  $model
     * @return array
     */
     ...
     *
     * @param  \MyPlugin\Framework\Database\Orm\Builder|null
     * @return $this
     */
    ...
    {
        return Str::camel(Str::plural(Model::classBasename($this->getParent())));
    }
