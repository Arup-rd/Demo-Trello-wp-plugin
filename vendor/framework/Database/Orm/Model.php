...
use MyPlugin\Framework\Support\Str;
use MyPlugin\Framework\Support\Arr;
use MyPlugin\Framework\Foundation\App;
use MyPlugin\Framework\Foundation\Dispatcher;
use MyPlugin\Framework\Support\JsonableInterface;
use MyPlugin\Framework\Support\ArrayableInterface;
use MyPlugin\Framework\Database\Orm\Relations\Pivot;
use MyPlugin\Framework\Database\Orm\Relations\HasOne;
use MyPlugin\Framework\Database\Orm\ModelHelperTrait;
use MyPlugin\Framework\Database\Orm\Relations\MorphTo;
use MyPlugin\Framework\Database\Orm\Relations\HasMany;
use MyPlugin\Framework\Database\Orm\Relations\MorphOne;
use MyPlugin\Framework\Database\Orm\Relations\MorphMany;
use MyPlugin\Framework\Database\Orm\Relations\Relation;
use MyPlugin\Framework\Database\Orm\Relations\BelongsTo;
use MyPlugin\Framework\Database\Orm\Relations\MorphToMany;
use MyPlugin\Framework\Database\Orm\Relations\BelongsToMany;
use MyPlugin\Framework\Database\Orm\Relations\HasManyThrough;
use MyPlugin\Framework\Database\Query\Builder as QueryBuilder;
use MyPlugin\Framework\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable
{
     ...
     *
     * @var \MyPlugin\Framework\Foundation\Dispatcher
     */
    ...
    {
        foreach (static::classUsesRecursive(get_called_class()) as $trait) {
            if (method_exists(get_called_class(), $method = 'boot'.static::classBasename($trait))) {
     ...
     *
     * @param  \MyPlugin\Framework\Database\Orm\ScopeInterface  $scope
     * @return void
     */
     ...
     *
     * @param  \MyPlugin\Framework\Database\Orm\ScopeInterface  $scope
     * @return \MyPlugin\Framework\Database\Orm\ScopeInterface|null
     */
     ...
     *
     * @return \MyPlugin\Framework\Database\Orm\ScopeInterface[]
     */
     ...
     * @return $this
     *
     * @throws \MyPlugin\Framework\Database\Orm\MassAssignmentException
     */
     ...
     *
     * @param  array  $columns
     * @return \MyPlugin\Framework\Database\Orm\Collection|static[]
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \MyPlugin\Framework\Support\Collection|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \MyPlugin\Framework\Support\Collection|static
     */
     ...
     * @return \MyPlugin\Framework\Support\Collection|static
     *
     * @throws \MyPlugin\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     *
     * @param  array|string  $relations
     * @return \MyPlugin\Framework\Database\Orm\Builder|static
     */
     ...
     * @return \MyPlugin\Framework\Database\Orm\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \MyPlugin\Framework\Database\Orm\Relations\MorphOne
     */
     ...
     * @return \MyPlugin\Framework\Database\Orm\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \MyPlugin\Framework\Database\Orm\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \MyPlugin\Framework\Database\Orm\Relations\HasMany
     */
     ...
     * @return \MyPlugin\Framework\Database\Orm\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \MyPlugin\Framework\Database\Orm\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool    $inverse
     * @return \MyPlugin\Framework\Database\Orm\Relations\MorphToMany
     */
     ...
     * @param  string  $table
     * @param  bool    $exists
     * @return \MyPlugin\Framework\Database\Orm\Relations\Pivot
     */
    ...
    protected function getRelationshipFromMethod($key, $camelKey)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                . 'MyPlugin\Framework\Database\Orm\Relations\Relation');
        }
    ...
    public function fromDateTime($value)
    {
        ...
        elseif (is_numeric($value)) {
            return $this->createFromTimestamp($value);
        }
        ...
        elseif (preg_match('/^(\d{4})-(\d{2})-(\d{2})$/', $value)) {
            return $this->createFromDateString($value);
        }
    ...
    protected function asDateTime($value)
    {
        ...
        return $this->newDateTimeString($value);
    }
     ...
     *
     * @return \MyPlugin\Framework\Foundation\Dispatcher
     */
     ...
     *
     * @param  \MyPlugin\Framework\Foundation\Dispatcher  $dispatcher
     * @return void
     */
