...
namespace MyPlugin\Framework\Database\Query;

use Closure;
use MyPlugin\Framework\Support\Arr;
use MyPlugin\Framework\Support\Str;
use MyPlugin\Framework\Support\Collection;
use MyPlugin\Framework\Database\Query\Grammar;
use MyPlugin\Framework\Database\Query\Processor;
use MyPlugin\Framework\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var MyPlugin\Framework\Database\Connection
     */
     ...
     *
     * @var MyPlugin\Framework\Database\Query\Grammars\Grammar
     */
    protected $grammar;
     ...
     *
     * @var MyPlugin\Framework\Database\Query\Processors\Processor
     */
    protected $processor;
     ...
     *
     * @param  MyPlugin\Framework\Database\ConnectionInterface  $connection
     * @param  MyPlugin\Framework\Database\Query\Grammars\Grammar  $grammar
     * @param  MyPlugin\Framework\Database\Query\Processors\Processor  $processor
     * @return void
     */
     ...
     * @return MyPlugin\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @param  MyPlugin\Framework\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  MyPlugin\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return MyPlugin\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @return MyPlugin\Framework\Database\Query\Builder
     */
     ...
     *
     * @return MyPlugin\Framework\Cache\CacheManager
     */
     ...
     * @param  int    $perPage
     * @param  array  $columns
     * @return MyPlugin\Framework\Pagination\Paginator
     */
    public function laravel_paginate($perPage = 15, $columns = array('*'))
    {
    ...
    public function paginate($perPage = 10, $columns = array('*'))
    {
        ...
        $page = intval(Arr::get($_REQUEST, 'page')) ?: 1;

        $data = $this->forPage($page, $perPage)->get($columns);

        $total = $this->getPaginationCount();

        $dataCount = count($data);

        $from = $dataCount > 0 ? ($page - 1) * $perPage + 1 : null;
     ...
     *
     * @param  MyPlugin\Framework\Pagination\Factory  $paginator
     * @param  int    $perPage
     * @param  array  $columns
     * @return MyPlugin\Framework\Pagination\Paginator
     */
     ...
     *
     * @param  mixed  $value
     * @return MyPlugin\Framework\Database\Query\Expression
     */
     ...
     *
     * @param  MyPlugin\Framework\Database\Query\Builder  $query
     * @return $this
     */
     ...
     *
     * @return MyPlugin\Framework\Database\ConnectionInterface
     */
     ...
     *
     * @return MyPlugin\Framework\Database\Query\Processor
     */
     ...
     *
     * @return MyPlugin\Framework\Database\Grammar
     */
